...
Eggs.List = {
	...
	},
	{
		...
		Description = "Warm to the touch. Hums with storm-fire.",
		Price = 75000,
		Currency = "Cash",
		RequiredLevel = 12,
		AssetModel = "LavaEgg",
		MarketStall = nil,
		HatchWeights = { Common = 60, Rare = 280, Epic = 390, Legendary = 260, Mythic = 65, Secret = 6 },
	},
	{
		Id = "Phantom",
		Tier = 6,
		DisplayName = "Phantom Egg",
		Description = "Half here, half somewhere richer.",
		Price = 650000,
		Currency = "Cash",
		RequiredLevel = 20,
		AssetModel = "ShadowEgg",
		MarketStall = nil,
		HatchWeights = { Common = 10, Rare = 110, Epic = 300, Legendary = 400, Mythic = 220, Secret = 28 },
	},
	{
		Id = "Toxic",
		Tier = 2,
