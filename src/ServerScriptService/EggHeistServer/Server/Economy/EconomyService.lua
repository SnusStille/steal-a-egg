-- EggHeist | Server/Economy/EconomyService.lua
...
-- NOTE: prestige/rebirth lives in Progression/ProgressionService.lua.
-- EconomyService only owns currencies, XP and multipliers.
